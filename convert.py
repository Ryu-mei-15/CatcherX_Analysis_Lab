...
元の CSV は変更せず，DataCourse から data.json と analysis-summary.json を生成する．
...
COURSE_DIR = ROOT / "DataCourse"
BREAK_DIR = ROOT / "DataBreak"
...
def build_summary(records):
    ...
    return {
        ...
        "generated_from": "DataCourse/*.csv and DataBreak/*_1_2.csv",
...
def main():
    ...
    with (ROOT / "analysis-summary.json").open("w", encoding="utf-8") as handle:
